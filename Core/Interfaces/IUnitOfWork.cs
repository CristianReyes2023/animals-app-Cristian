...
namespace Core.Interfaces;//Es una estrategia que vamos a tener para poder agrupar todos los repositorios y interfaces en una sola clase.Esto con el objetivo de optimizar el uso de recursos de memoria especificamente.
